...
import { Search, Filter, ChevronDown, MoreVertical, Edit, Eye } from "lucide-react";
...
const StoreProducts = () => {
  ...
  const sampleProducts = [
    ...
    },
    {
      ...
      stock: 25,
      status: "active",
      image: "https://images.unsplash.com/photo-1447175008436-1701707d7aa8?w=200&h=200&fit=crop",
      tags: ["Fresh", "Organic"],
    },
    {
      id: 3,
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <button className="flex-1 px-3 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary/90 transition-colors">
                    View
                  </button>
                </div>
              </div>
